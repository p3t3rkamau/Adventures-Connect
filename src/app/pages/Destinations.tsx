                ...
                >
                  <div className="aspect-[16/10] relative">
                    ...
                    <div className="absolute inset-0 p-8 flex flex-col justify-end text-white">
                      ...
                      <h2 className="text-3xl md:text-4xl font-bold mb-3">{destination.name}</h2>
                      <p className="text-lg text-gray-200 mb-6">{destination.description}</p>
                      
                      <div className="mb-6">
                        <div className="text-sm text-gray-300 mb-2">Top Attractions:</div>
                        <div className="flex flex-wrap gap-2">
                          {destination.highlights.map((highlight, i) => (
                            <span key={i} className="flex items-center gap-1 bg-white/10 backdrop-blur-sm px-3 py-1 rounded-full text-sm">
